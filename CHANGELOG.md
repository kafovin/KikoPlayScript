...
+ tmdb.lua - 0.1.2.220305_build

  + minor feature：微调
  
    + 增加了设置项`搜索 - 是否显示更多季`，用来设置当`搜索 - 关键词处理`设置为`filename`时的搜索操作。
  
      没识别到季序号时，是显示全部季数，还是仅显示第1季或特别篇。

    + 在资料库媒体海报的右键菜单有改动，打开IMDb及TMDb合并为`打开TMDb/IMDb`，增加了 `使用豆瓣/贴吧搜索`、`打开fanart页面`、`使用字幕搜索`。(220303_build)

    + 可以设置 演职员表最多显示的人员数。(220303_build)

+ tvmazelist.lua - 0.1.0.220305_build

  + feature：新特性

    + 右键剧集一行，可以选择打开字幕搜索页。(220303_build)
...
+ tvmazelist.lua - 0.1.0.220302_build
